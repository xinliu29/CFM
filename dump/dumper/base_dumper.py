...
class BaseDumper(metaclass=ABCMeta):
    ...
    def form_standard_dataset(self):
        dataset_path = os.path.join(self.config['dataset_dump_dir'], self.config['data_name'] + \
                                    '_' + self.config['extractor']['name'] + '_' +
                                    str(self.config['extractor']['num_kpt']) + '.hdf5')
        ...
        with h5py.File(dataset_path, 'w') as f:
            ...
            for idx in trange(num_pairs):
                ...
                desc1, desc2 = desc_file1['descriptors'][()], desc_file2['descriptors'][()]
                kpt1, kpt2 = desc_file1['keypoints'][()], desc_file2['keypoints'][()]
