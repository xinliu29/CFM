...
for NUM_KPT in "${NUM_KPTS[@]}"; do
    echo "Running evaluation for num of keypoints: $NUM_KPT"
    ...
    --output_file $OUTPUT_FILE --num_kpt $NUM_KPT

    echo "Finished evaluation for num of keypoints: $NUM_KPT"
done